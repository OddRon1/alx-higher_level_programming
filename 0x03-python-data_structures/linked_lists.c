 ...
 * @h: this is the pointer to the head of list
 ...
 * @head: this is the pointer to the pointer of first node of listint_t list
 * @n: this is the integer to be included in new node
